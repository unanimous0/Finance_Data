...
> **마지막 업데이트**: 2026-03-09 (리눅스 서버 환경 세팅 완료, 3/4 수집 진행 중)
> **프로젝트 상태**: Phase 4 완료 / 최신 데이터 2026-03-03 / 3/4~3/6 누락 수집 진행 중
...
| 테이블 | 레코드 수 | 기간 | 종목 수 |
|--------|----------|------|---------|
| stocks | 3,797건 | - | 활성 3,794개 (비활성 3개) |
| ohlcv_daily | 3,279,487건 | 2022-01-03 ~ 2026-03-03 | 3,794개 |
| market_cap_daily | 3,279,487건 | 2022-01-03 ~ 2026-03-03 | 3,794개 |
| investor_trading | 10,096,996건 | 2022-01-03 ~ 2026-03-03 | 2,719개 (KOSPI+KOSDAQ) |
