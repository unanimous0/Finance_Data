...
> **마지막 업데이트**: 2026-03-11
> **프로젝트 상태**: Phase 4 완료 / 최신 데이터 2026-03-10 / 스케줄러 재가동 필요
...
## 📊 현재 데이터 현황 (2026-03-11 기준)

### 적재 완료 데이터

| 테이블 | 레코드 수 | 기간 | 종목 수 |
|--------|----------|------|---------|
| stocks | 3,802건 | - | 활성 3,799개 (비활성 3개) |
| ohlcv_daily | ~3,430,000건 | 2022-01-03 ~ 2026-03-10 | 3,798개 |
| market_cap_daily | ~3,430,000건 | 2022-01-03 ~ 2026-03-10 | 3,798개 |
| investor_trading | ~10,520,000건 | 2022-01-03 ~ 2026-03-10 | 2,721개 (KOSPI+KOSDAQ) |
