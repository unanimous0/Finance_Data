...
> **마지막 업데이트**: 2026-02-25 (94개 ETF 과거 데이터 보충, 2/24 수집 완료, 481200 비활성화, 보고서 급등락 TOP 30 개선)
...
## 📊 현재 데이터 현황 (2026-02-25 기준)

### 적재 완료 데이터

| 테이블 | 레코드 수 | 기간 | 종목 수 |
|--------|----------|------|---------|
| stocks | 3,793건 | - | 활성 3,791개 (비활성 2개) |
| ohlcv_daily | 3,264,313건 | 2022-01-03 ~ 2026-02-24 | 3,791개 |
| market_cap_daily | 3,264,313건 | 2022-01-03 ~ 2026-02-24 | 3,791개 |
| investor_trading | 10,053,492건 | 2022-01-03 ~ 2026-02-24 | 2,720개 (KOSPI+KOSDAQ) |
| **합계** | **~16.6M건** | **4년치** | - |
