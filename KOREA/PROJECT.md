...
> **마지막 업데이트**: 2026-03-01 (DB 복원 완료, 2/26까지 데이터 정상)
> **프로젝트 상태**: Phase 4 완료 / DB 복원 완료 / 스케줄러 재가동 필요
...
- DB 복원 완료 ✅ (2026-03-01): backup_20260227_2331.dump → 2/26까지 데이터 정상
- 미완료: 스케줄러 재가동, 2/27~ 누락 데이터 수집, 서버 구축

---

## 📊 현재 데이터 현황 (2026-02-27 기준)

### 적재 완료 데이터

| 테이블 | 레코드 수 | 기간 | 종목 수 |
|--------|----------|------|---------|
| stocks | 3,797건 | - | 활성 3,795개 (비활성 2개) |
| ohlcv_daily | 3,271,899건 | 2022-01-03 ~ 2026-02-26 | 3,795개 |
| market_cap_daily | 3,271,899건 | 2022-01-03 ~ 2026-02-26 | 3,795개 |
| investor_trading | 10,075,252건 | 2022-01-03 ~ 2026-02-26 | 2,720개 (KOSPI+KOSDAQ) |
